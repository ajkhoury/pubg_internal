...
#include "../../Engine/UE4/GenericTypes.h"
#include "../../Engine/ObjectsStore.h"
#include "../../Engine/NamesStore.h"
#include "../../Engine/NameValidator.h"
...
{
    int32_t InternalIndex = __ROL4__(object->InternalIndexEncrypted.Dword ^ 0xA2579305, 8);
    InternalIndex = InternalIndex ^ (InternalIndex << 16) ^ 0xA1790A2D;
