...
public:
    bool Initialize(void* module) override
    {
        ...
        virtualFunctionPattern["Class CoreUObject.Object"] = {
            { "\x45\x33\xF6\x3B\x05\xCC\xCC\xCC\xCC\x4D\x8B\xE0", 12, 0x200, 
R"(    inline void ProcessEvent(class UFunction* function, void* params)
    {
        return GetVFunction<void(*)(UObject*, class UFunction*, void*)>(this, %d)(this, function, params);
    })" }
        };
        virtualFunctionPattern["Class CoreUObject.Class"] = {
            { "\x4C\x8B\xDC\x57\x48\x81\xEC", 7, 0x200,
...
public:
    ...
    inline T& operator[](int32_t i) { return Data[i]; }
    inline const T& operator[](int32_t i) const { return Data[i]; }
    inline bool IsValidIndex(int32_t i) const { return i < Num(); }
